...
<body class="h-100">
    <header>
        <nav>
            <ul>
                <li class="mb-4">
                    <a href="#" class="logo"><img src="../assets/img/ecosaba.png" alt=""><span class="nav-item-custom text-white">Pastelería</span></a>
                </li>
				...
				<li><a href="http://localhost:8070/crud_pasteleria/Page/Pastel_ingrediente"><i class="fa-solid fa-rectangle-list"></i><span class="nav-item-custom">Pastel - ingrediente</span></a></li>
    ...
    <div class="container-fluid py-5 content" style="height:100vh">